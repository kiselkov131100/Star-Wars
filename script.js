...
Есть сервис https://swapi.dev/ , здесь размещено API по которому можно забрать информацию по персонажам/кораблям вселенной звездных войн. 
...
1. Надо сделать страницу, на которой изначально будет 2 пустые карточки (просто контейнер с границами).
...
2. Добавить страницу с результатами, где будет показываться кол-во побед игрока 1 и игрока 2 за все время 
